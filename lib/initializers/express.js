...
module.exports = function bootstrap () {
  ...
  app.use('/public/css', express.static(path.join(process.cwd(), 'node_modules/bootstrap')))
  app.use('/public/css', express.static(path.join(process.cwd(), 'node_modules/font-awesome')))
  app.use('/public/fonts', express.static(path.join(process.cwd(), 'node_modules/font-awesome/fonts')))
